...
📕 I enjoy learning about history and visiting museums</br>

**😎 Fun facts:**  
🤴 I'm a descendant of King James VI of Scotland and I of England</br>
🚢 I had family on the Titanic</br>
...
Developed in C# and uses .NET Entity Framework</br>*

🔢 **Applied Machine Learning Uni Assignment - Decision Tress with Regression to Predict US House Prices based on features, location etc:**  
*Analysed and made predictions on the US House Prices dataset from Kaggle using Decision Trees with Regression</br>
Developed in R</br>*

🍋 **Immersive Technology Uni Assignment - Lemonade AR!:**  
*A fun interactive AR version of my "Lemonade!" mobile game designed for children</br>
Developed in Unity (C#), targeting iOS and Android devices</br>*  
